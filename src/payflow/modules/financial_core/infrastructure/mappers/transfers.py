...
from payflow.modules.financial_core.domain.transfers import Transfer, TransferStatus
from payflow.modules.financial_core.infrastructure.models import TransferModel
