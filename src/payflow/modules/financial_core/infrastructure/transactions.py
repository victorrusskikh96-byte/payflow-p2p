"""SQLAlchemy-менеджеры транзакций финансового ядра."""
...
class SQLAlchemyTransactionManager:
    """Управляет транзакцией SQLAlchemy-сессии для финансового ядра use cases."""
...
class SQLAlchemyLedgerTransactionManager:
    """Управляет транзакцией SQLAlchemy-сессии для ledger use cases."""
